...
import { R as React, a as reactExports, i as useParams, u as useNavigate } from "./react-vendor-cEae-lCc.js";
import { u as useAuth, B as Button, c as apiClient, S as Spinner, C as Card } from "./index-C0G9mbri.js";
import "./state-vendor-B_izx0oA.js";
const ideSelector = "_ideSelector_vkhcu_5";
const ideLabel = "_ideLabel_vkhcu_14";
const ideTabs = "_ideTabs_vkhcu_20";
const ideTab = "_ideTab_vkhcu_20";
const active$1 = "_active_vkhcu_54";
const ideIcon = "_ideIcon_vkhcu_65";
const ideText = "_ideText_vkhcu_69";
const styles$7 = {
  ideSelector,
  ideLabel,
  ideTabs,
...
const IDESelector = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.ideSelector, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.ideLabel, children: "IDE:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.ideTabs, children: ides.map(({ type, label, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        className: `${styles$7.ideTab} ${selectedIDE === type ? styles$7.active : ""}`,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.ideIcon, children: icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.ideText, children: label })
        ]
      },
      type
    )) })
...
const fileExplorer = "_fileExplorer_qw5a4_5";
const fileExplorerHeader = "_fileExplorerHeader_qw5a4_12";
const fileActions = "_fileActions_qw5a4_29";
const actionBtn = "_actionBtn_qw5a4_34";
const newFileForm = "_newFileForm_qw5a4_48";
const newFileInput = "_newFileInput_qw5a4_54";
const fileList = "_fileList_qw5a4_70";
const fileItem = "_fileItem_qw5a4_76";
const active = "_active_qw5a4_91";
const fileIcon = "_fileIcon_qw5a4_96";
const fileName = "_fileName_qw5a4_100";
const modifiedIndicator = "_modifiedIndicator_qw5a4_105";
const emptyState$1 = "_emptyState_qw5a4_111";
const styles$6 = {
  fileExplorer,
  fileExplorerHeader,
  fileActions,
...
const FileExplorer = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.fileExplorer, id: "file-explorer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.fileExplorerHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Files" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.fileActions, children: [
    ...
    isCreatingFile && /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleCreateFile, className: styles$6.newFileForm, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        id: "new-file-name",
        type: "text",
        ...
        className: styles$6.newFileInput,
        autoFocus: true
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.fileList, children: [
      files.map((file) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `${styles$6.fileItem} ${currentFile?.id === file.id ? styles$6.active : ""}`,
          onClick: () => onFileSelect(file.id),
          "data-filename": file.name,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.fileIcon, children: getFileIcon(file.language) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.fileName, children: file.name }),
            file.isModified && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.modifiedIndicator, children: "●" })
          ]
        },
        file.id
      )),
      files.length === 0 && !isCreatingFile && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.emptyState, children: "No files yet. Click 📄 to create one." })
    ] })
  ] });
};
...
var Ft = de;
const codeEditor = "_codeEditor_1rmyy_5";
const editorLoading = "_editorLoading_1rmyy_13";
const spinner$1 = "_spinner_1rmyy_24";
const readOnlyOverlay$1 = "_readOnlyOverlay_1rmyy_39";
const readOnlyBadge = "_readOnlyBadge_1rmyy_48";
const styles$5 = {
  codeEditor,
  editorLoading,
  spinner: spinner$1,
  readOnlyOverlay: readOnlyOverlay$1,
  readOnlyBadge
};
const CodeEditor = reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.codeEditor, id: "code-editor", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ft,
      {
        height,
        ...
        loading: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.editorLoading, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.spinner }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Loading editor..." })
        ] })
      }
    ),
    readOnly && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.readOnlyOverlay, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$5.readOnlyBadge, children: "Read Only - Start lab to edit" }) })
  ] });
});
      ...
      var e = { 6: (e2, t2) => {
        ...
        class o2 {
          static computeLink(e3, t3, r, i) {
            const s = new RegExp(t3.source, (t3.flags || "") + "g"), [a, c] = o2._getWindowedLineStrings(e3 - 1, r), l2 = a.join("");
            let d;
            const p = [];
            for (; d = s.exec(l2); ) {
              const e4 = d[0];
              if (!n2(e4)) continue;
              const [t4, s2] = o2._mapStrIdx(r, c, 0, d.index), [a2, l3] = o2._mapStrIdx(r, t4, s2, e4.length);
              if (-1 === t4 || -1 === s2 || -1 === a2 || -1 === l3) continue;
              const h2 = { start: { x: s2 + 1, y: t4 + 1 }, end: { x: l3, y: a2 + 1 } };
...
const terminalContainer = "_terminalContainer_b1uk3_5";
const terminalHeader$1 = "_terminalHeader_b1uk3_13";
const terminalTitle = "_terminalTitle_b1uk3_22";
const terminalActions = "_terminalActions_b1uk3_30";
const terminalActionBtn = "_terminalActionBtn_b1uk3_35";
const terminal = "_terminal_b1uk3_5";
const executingIndicator = "_executingIndicator_b1uk3_60";
const executingSpinner = "_executingSpinner_b1uk3_78";
const readOnlyOverlay = "_readOnlyOverlay_b1uk3_93";
const readOnlyMessage = "_readOnlyMessage_b1uk3_108";
const styles$4 = {
  terminalContainer,
  terminalHeader: terminalHeader$1,
  terminalTitle,
  terminalActions,
  terminalActionBtn,
  terminal,
...
const TerminalEmulator = ({
  ...
  const promptRef = reactExports.useRef("$ ");
  reactExports.useEffect(() => {
    ...
    terminal2.loadAddon(webLinksAddon);
    terminal2.open(terminalRef.current);
    fitAddon.fit();
    xtermRef.current = terminal2;
    fitAddonRef.current = fitAddon;
    terminal2.writeln("\x1B[1;32mLab Terminal Environment\x1B[0m");
    terminal2.writeln("\x1B[90mType commands and press Enter to execute\x1B[0m");
    terminal2.writeln("");
    terminal2.write(promptRef.current);
    let currentLine = "";
    terminal2.onData((data) => {
      ...
      if (data === "\x1B[A") {
        if (commandHistory.length > 0 && historyIndex < commandHistory.length - 1) {
          ...
          terminal2.write("\r\x1B[K");
          terminal2.write(promptRef.current);
          terminal2.write(historicCommand);
  ...
  const handleCommand = async (command) => {
    const terminal2 = xtermRef.current;
    if (!terminal2) return;
    try {
      await onExecuteCommand(command);
    } catch (error) {
      terminal2.writeln(`\x1B[1;31mError: ${error}\x1B[0m`);
      terminal2.write(promptRef.current);
    }
  };
  reactExports.useEffect(() => {
    const terminal2 = xtermRef.current;
    if (!terminal2 || history.length === 0) return;
    const lastCommand = history[history.length - 1];
    if (lastCommand.output) {
      const lines = lastCommand.output.split("\n");
      lines.forEach((line) => {
        terminal2.writeln(line);
      });
    }
    if (lastCommand.exitCode !== 0) {
      terminal2.writeln(`\x1B[1;31m[Exit code: ${lastCommand.exitCode}]\x1B[0m`);
    }
    terminal2.write(promptRef.current);
  }, [history]);
  const handleClear = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.terminalContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.terminalHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.terminalTitle, children: "Terminal" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.terminalActions, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          id: "clear-terminal-btn",
          className: styles$4.terminalActionBtn,
          onClick: handleClear,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        ref: terminalRef,
        className: styles$4.terminal,
        id: "terminal-emulator"
      }
    ),
    isExecuting && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.executingIndicator, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.executingSpinner }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Executing..." })
    ] }),
    readOnly && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.readOnlyOverlay, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.readOnlyMessage, children: "Terminal is read-only. Start lab to execute commands." }) })
  ] });
};
const resourceMonitor = "_resourceMonitor_bck58_5";
const monitorHeader = "_monitorHeader_bck58_13";
const monitorTitle = "_monitorTitle_bck58_25";
const liveIndicator = "_liveIndicator_bck58_33";
const refreshBtn = "_refreshBtn_bck58_52";
const metricsContainer = "_metricsContainer_bck58_67";
const metric = "_metric_bck58_67";
const metricHeader = "_metricHeader_bck58_84";
const metricIcon = "_metricIcon_bck58_90";
const metricLabel = "_metricLabel_bck58_94";
const metricValue = "_metricValue_bck58_102";
const metricSubtext = "_metricSubtext_bck58_109";
const progressBar = "_progressBar_bck58_114";
const progressFill = "_progressFill_bck58_122";
const normal = "_normal_bck58_128";
const warning = "_warning_bck58_132";
const critical = "_critical_bck58_136";
const networkMetrics = "_networkMetrics_bck58_140";
const networkMetric = "_networkMetric_bck58_140";
const networkLabel = "_networkLabel_bck58_155";
const networkValue = "_networkValue_bck58_161";
const alertContainer = "_alertContainer_bck58_167";
const alert = "_alert_bck58_167";
const alertIcon = "_alertIcon_bck58_183";
const alertText = "_alertText_bck58_188";
const styles$3 = {
  resourceMonitor,
  monitorHeader,
  monitorTitle,
...
const ResourceMonitor = ({
  ...
  const [displayTime, setDisplayTime] = reactExports.useState(sessionTime);
  reactExports.useEffect(() => {
    if (!isLive) return;
  ...
  const getUsageLevel = (percentage) => {
    if (percentage >= 90) return styles$3.critical;
    if (percentage >= 75) return styles$3.warning;
    return styles$3.normal;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.resourceMonitor, id: "resource-monitor", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.monitorHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.monitorTitle, children: "Resources" }),
      isLive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.liveIndicator, children: "● Live" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricsContainer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metric, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricHeader, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricIcon, children: "⏱️" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricLabel, children: "Session Time" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.metricValue, children: formatTime(displayTime) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metric, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricHeader, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricIcon, children: "💻" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricLabel, children: "CPU" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricValue, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.progressBar, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `${styles$3.progressFill} ${getUsageLevel(resourceUsage.cpu)}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metric, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricHeader, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricIcon, children: "🧠" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricLabel, children: "Memory" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricValue, children: [
          formatBytes(resourceUsage.memory.used),
          " / ",
          formatBytes(resourceUsage.memory.total)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.progressBar, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `${styles$3.progressFill} ${getUsageLevel(resourceUsage.memory.percentage)}`,
            style: { width: `${resourceUsage.memory.percentage}%` }
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricSubtext, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metric, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricHeader, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricIcon, children: "💾" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricLabel, children: "Disk" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricValue, children: [
          resourceUsage.disk.used.toFixed(1),
          " GB / ",
          resourceUsage.disk.total.toFixed(1),
          " GB"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.progressBar, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `${styles$3.progressFill} ${getUsageLevel(resourceUsage.disk.percentage)}`,
      ...
      resourceUsage.network && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metric, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.metricHeader, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricIcon, children: "🌐" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.metricLabel, children: "Network" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.networkMetrics, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.networkMetric, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.networkLabel, children: "↓ RX:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$3.networkValue, children: [
              resourceUsage.network.rx.toFixed(2),
              " MB/s"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.networkMetric, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.networkLabel, children: "↑ TX:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$3.networkValue, children: [
              resourceUsage.network.tx.toFixed(2),
              " MB/s"
            ] })
          ] })
        ] })
    ...
    (resourceUsage.cpu >= 90 || resourceUsage.memory.percentage >= 90 || resourceUsage.disk.percentage >= 90) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.alertContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.alert, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.alertIcon, children: "⚠️" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.alertText, children: "High resource usage detected. Performance may be impacted." })
    ] }) })
  ] });
};
const aiAssistant = "_aiAssistant_6i3lh_5";
const assistantHeader = "_assistantHeader_6i3lh_12";
const headerTitle = "_headerTitle_6i3lh_21";
const headerActions = "_headerActions_6i3lh_27";
const clearBtn = "_clearBtn_6i3lh_32";
const connectedDot = "_connectedDot_6i3lh_48";
const pulse$1 = "_pulse_6i3lh_1";
const aiIcon = "_aiIcon_6i3lh_60";
const contextToggle = "_contextToggle_6i3lh_73";
const checkbox = "_checkbox_6i3lh_79";
const checkboxLabel = "_checkboxLabel_6i3lh_85";
const contextIndicator = "_contextIndicator_6i3lh_92";
const connectionError = "_connectionError_6i3lh_102";
const connecting = "_connecting_6i3lh_111";
const connectingSpinner = "_connectingSpinner_6i3lh_123";
const spin = "_spin_6i3lh_1";
const quickActions = "_quickActions_6i3lh_136";
const quickActionBtn = "_quickActionBtn_6i3lh_144";
const quickActionIcon = "_quickActionIcon_6i3lh_170";
const quickActionLabel = "_quickActionLabel_6i3lh_174";
const messagesContainer = "_messagesContainer_6i3lh_181";
const emptyState = "_emptyState_6i3lh_190";
const emptyIcon = "_emptyIcon_6i3lh_201";
const emptyHint = "_emptyHint_6i3lh_210";
const message = "_message_6i3lh_181";
const user = "_user_6i3lh_225";
const assistant = "_assistant_6i3lh_12";
const system = "_system_6i3lh_238";
const messageHeader = "_messageHeader_6i3lh_247";
const messageRole = "_messageRole_6i3lh_255";
const messageTime = "_messageTime_6i3lh_259";
const messageContent = "_messageContent_6i3lh_263";
const messageContext = "_messageContext_6i3lh_269";
const contextTag = "_contextTag_6i3lh_276";
const loadingIndicator = "_loadingIndicator_6i3lh_286";
const loadingDot = "_loadingDot_6i3lh_292";
const bounce = "_bounce_6i3lh_1";
const inputContainer = "_inputContainer_6i3lh_317";
const messageInput = "_messageInput_6i3lh_325";
const styles$2 = {
  aiAssistant,
  assistantHeader,
  headerTitle,
...
const AIAssistant = ({
  ...
  const { user: user2, token } = useAuth();
  ...
  const [includeContext, setIncludeContext] = reactExports.useState(true);
  ...
  const getFileName = reactExports.useCallback(() => {
    if (!currentFile) return void 0;
    if (typeof currentFile === "string") return currentFile;
    return currentFile.name || currentFile.path;
  }, [currentFile]);
  const getFileLanguage = reactExports.useCallback(() => {
    if (!currentFile || typeof currentFile === "string") return void 0;
    return currentFile.language;
  }, [currentFile]);
  const getLastTerminalError = reactExports.useCallback(() => {
    if (lastError) return lastError;
    for (let i = terminalHistory.length - 1; i >= 0; i--) {
      const entry = terminalHistory[i];
      if (entry.output && (entry.output.toLowerCase().includes("error") || entry.output.toLowerCase().includes("exception") || entry.output.toLowerCase().includes("traceback"))) {
        return entry.output;
      }
    }
    return void 0;
  ...
  }, [user2, token, sessionId2, courseId2, getFileName, getFileLanguage]);
  ...
  const sendMessage = reactExports.useCallback((messageText) => {
    ...
    const context = includeContext ? {
      ...
      code: hasJupyterContext ? void 0 : codeContent?.substring(0, 2e3),
...
${contextParts.join("\n")}`;
  ...
  const quickActions2 = hasJupyterContext ? [
    {
      id: "explain-cell",
      label: "Explain Cell",
      icon: "📖",
  ...
  const hasCode = hasJupyterContext ? Boolean(jupyterContext?.codeCells && jupyterContext.codeCells > 0) : Boolean(codeContent);
  const hasError = hasJupyterContext ? Boolean(jupyterContext?.hasErrors) : Boolean(getLastTerminalError());
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.aiAssistant, id: "ai-assistant", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.assistantHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.headerTitle, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.aiIcon, children: "🤖" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "AI Assistant" }),
        isConnected && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.connectedDot, title: "Connected to AI Pipeline", children: "●" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.headerActions, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.contextToggle, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "include-context", className: styles$2.checkboxLabel, children: "Include code context" }),
      includeContext && (hasCode || hasJupyterContext) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$2.contextIndicator, title: hasJupyterContext ? "Notebook context will be included" : "Code will be included", children: [
        hasJupyterContext ? "📓" : "📄",
        " ",
        hasJupyterContext ? jupyterContext?.notebookName : getFileName() || "code"
      ] })
    ] }),
    connectionError2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.connectionError, children: connectionError2 }),
    !isConnected && !connectionError2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.connecting, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.connectingSpinner }),
      "Connecting to AI Pipeline..."
    ] }),
    isConnected && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.quickActions, children: quickActions2.map((action) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        className: styles$2.quickActionBtn,
        onClick: () => handleQuickAction(action),
        disabled: isLoading || action.requiresCode && !hasCode || action.requiresError && !hasError,
        title: action.requiresCode && !hasCode ? "Requires code in editor" : action.requiresError && !hasError ? "No error detected" : action.label,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.quickActionIcon, children: action.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.quickActionLabel, children: action.label })
        ]
      },
      action.id
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.messagesContainer, children: [
      messages.length === 0 && isConnected && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.emptyState, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.emptyIcon, children: "💬" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Ask me anything about your code!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: styles$2.emptyHint, children: [
      ...
      messages.map((message2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `${styles$2.message} ${styles$2[message2.role]}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.messageHeader, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.messageRole, children: message2.role === "user" ? "👤 You" : "🤖 Assistant" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.messageTime, children: formatTime(message2.timestamp) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.messageContent, children: message2.content }),
            message2.context && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.messageContext, children: [
              message2.context.file && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$2.contextTag, children: [
                "📄 ",
                message2.context.file
              ] }),
              message2.context.error && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.contextTag, children: "❌ Error context included" })
            ] })
          ]
        },
        message2.id
      )),
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${styles$2.message} ${styles$2.assistant}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.messageHeader, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.messageRole, children: "🤖 Assistant" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.loadingIndicator, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.loadingDot }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.loadingDot }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.loadingDot })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.inputContainer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          ref: inputRef,
          id: "ai-message-input",
          className: styles$2.messageInput,
          value: inputMessage,
...
const labControls = "_labControls_1oyip_5";
const statusMessage = "_statusMessage_1oyip_11";
const spinner = "_spinner_1oyip_22";
const styles$1 = {
  labControls,
  statusMessage,
  spinner
...
const LabControls = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.labControls, children: [
    status === "stopped" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        id: "start-lab-btn",
        variant: "primary",
    ...
    status === "paused" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          id: "resume-lab-btn",
    ...
    (status === "starting" || status === "stopping") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.statusMessage, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.spinner }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: status === "starting" ? "Starting..." : "Stopping..." })
    ] })
  ] });
};
const useLabSession = (labId, courseId2) => {
  const [session, setSession] = reactExports.useState(null);
  const [status, setStatus] = reactExports.useState("stopped");
  const [isLoading, setIsLoading] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const wsRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    if (!labId || !courseId2) return;
    const checkExistingSession = async () => {
      try {
        setIsLoading(true);
        const response = await fetch(
          `https://176.9.99.103:8005/api/v1/labs/session?labId=${labId}&courseId=${courseId2}`,
          {
            credentials: "include",
            headers: {
  ...
  const connectWebSocket = reactExports.useCallback((sessionId2) => {
    if (wsRef.current) {
      wsRef.current.close();
    }
    const ws = new WebSocket(`wss://176.9.99.103:8005/ws/lab/${sessionId2}`);
    ws.onopen = () => {
      console.log("WebSocket connected for lab session:", sessionId2);
    };
    ws.onmessage = (event) => {
      try {
        const data = JSON.parse(event.data);
  ...
  const startLab = reactExports.useCallback(async () => {
    if (!labId || !courseId2) {
    ...
    try {
      ...
      const response = await fetch(
        "https://176.9.99.103:8005/api/v1/labs/start",
        {
          ...
          body: JSON.stringify({ labId, courseId: courseId2 })
        }
      );
      if (!response.ok) {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to start lab";
      setError(message2);
      setStatus("stopped");
      throw err;
    } finally {
  ...
  }, [labId, courseId2, connectWebSocket]);
  const pauseLab = reactExports.useCallback(async () => {
    if (!session) {
    ...
    try {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to pause lab";
      setError(message2);
      throw err;
    } finally {
      setIsLoading(false);
  ...
  const resumeLab = reactExports.useCallback(async () => {
    if (!session) {
      setError("No active session");
      return;
    }
    try {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to resume lab";
      setError(message2);
      throw err;
    } finally {
      setIsLoading(false);
  ...
  const stopLab = reactExports.useCallback(async () => {
    if (!session) {
      setError("No active session");
      return;
    }
    try {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to stop lab";
      setError(message2);
      throw err;
    } finally {
      setIsLoading(false);
...
const useFileSystem = (sessionId2) => {
  ...
  reactExports.useEffect(() => {
    ...
    const loadFiles = async () => {
      try {
        setIsLoading(true);
        const response = await fetch(
          `https://176.9.99.103:8005/api/v1/labs/${sessionId2}/files`,
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json"
  ...
  const createFile = reactExports.useCallback(async (name, content = "") => {
    if (!sessionId2) {
    ...
    try {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to create file";
      setError(message2);
      throw err;
    } finally {
      setIsLoading(false);
  ...
  const openFile = reactExports.useCallback(async (fileId) => {
    if (!sessionId2) {
      throw new Error("No active session");
    }
    try {
      ...
      setError(null);
      const response = await fetch(
        `https://176.9.99.103:8005/api/v1/labs/${sessionId2}/files/${fileId}`,
        {
          credentials: "include",
          headers: {
            "Content-Type": "application/json"
  ...
  const saveFile = reactExports.useCallback(async (fileId, content) => {
    if (!sessionId2) {
      throw new Error("No active session");
    }
    try {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to save file";
      setError(message2);
      throw err;
    }
  }, [sessionId2, currentFile]);
  const deleteFile = reactExports.useCallback(async (fileId) => {
    if (!sessionId2) {
      throw new Error("No active session");
    }
    try {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to delete file";
      setError(message2);
      throw err;
    } finally {
      setIsLoading(false);
    }
  }, [sessionId2, currentFile, files]);
  const renameFile = reactExports.useCallback(async (fileId, newName) => {
    if (!sessionId2) {
      throw new Error("No active session");
    }
    try {
      ...
      setError(null);
      const response = await fetch(
        `https://176.9.99.103:8005/api/v1/labs/${sessionId2}/files/${fileId}/rename`,
        {
          method: "PATCH",
          credentials: "include",
          headers: {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to rename file";
      setError(message2);
      throw err;
    } finally {
      setIsLoading(false);
  ...
  const createFolder = reactExports.useCallback(async (name) => {
    if (!sessionId2) {
      throw new Error("No active session");
    }
    try {
      ...
      setError(null);
      const response = await fetch(
        `https://176.9.99.103:8005/api/v1/labs/${sessionId2}/folders`,
        {
          method: "POST",
          credentials: "include",
          headers: {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to create folder";
      setError(message2);
      throw err;
    } finally {
      setIsLoading(false);
...
const useTerminal = (sessionId2) => {
  const [history, setHistory] = reactExports.useState([]);
  const [isExecuting, setIsExecuting] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const executeCommand = reactExports.useCallback(async (command) => {
    if (!sessionId2) {
      throw new Error("No active session");
    }
    if (!command.trim()) {
    ...
    try {
      ...
      setError(null);
      const response = await fetch(
        `https://176.9.99.103:8005/api/v1/labs/${sessionId2}/execute`,
        {
          method: "POST",
          credentials: "include",
          headers: {
      ...
      const message2 = err instanceof Error ? err.message : "Command execution failed";
      setError(message2);
      const errorResult = {
        command: command.trim(),
        output: `Error: ${message2}`,
        exitCode: 1,
        timestamp: /* @__PURE__ */ new Date()
      };
...
function useJupyterNotebook(options) {
  const {
    labId,
    enablePolling = true,
    pollInterval = 5e3,
  ...
  const transformCell = (cell, index2) => ({
    index: typeof cell.index === "number" ? cell.index : index2,
    cellType: cell.cell_type || cell.cellType || "code",
    source: cell.source || "",
    executionCount: cell.execution_count,
    hasError: Boolean(cell.has_error || cell.hasError),
    errorMessage: cell.error_message || cell.error || cell.errorMessage,
    outputs: cell.outputs
  });
  const fetchNotebookContext = reactExports.useCallback(async () => {
    if (!labId) {
      setContext(DEFAULT_CONTEXT);
      return;
    }
    const now = Date.now();
    if (now - lastFetchRef.current < 2e3) {
      return;
    }
    ...
    try {
      ...
      const message2 = err instanceof Error ? err.message : "Failed to fetch notebook";
      setError(message2);
  ...
  const getCell = reactExports.useCallback(async (cellIndex) => {
  ...
  const listNotebooks = reactExports.useCallback(async () => {
    if (!labId) {
      return [];
    }
    try {
      ...
      return files.filter((f) => f.type === "notebook").map((f) => f.path);
    } catch (err) {
      console.error("[useJupyterNotebook] Failed to list notebooks:", err);
      return [];
    }
  }, [labId]);
  const getAIContext = reactExports.useCallback(() => {
...
const labContainer = "_labContainer_1onub_9";
const labHeader = "_labHeader_1onub_21";
const labTitle = "_labTitle_1onub_32";
const courseId = "_courseId_1onub_45";
const headerControls = "_headerControls_1onub_53";
const sessionTimer = "_sessionTimer_1onub_60";
const timerIcon = "_timerIcon_1onub_70";
const timerValue = "_timerValue_1onub_74";
const sessionStatus = "_sessionStatus_1onub_80";
const statusIndicator = "_statusIndicator_1onub_89";
const pulse = "_pulse_1onub_1";
const stopped = "_stopped_1onub_96";
const starting = "_starting_1onub_101";
const stopping = "_stopping_1onub_102";
const running = "_running_1onub_106";
const paused = "_paused_1onub_110";
const statusText = "_statusText_1onub_114";
const sessionId = "_sessionId_1onub_121";
const labContent = "_labContent_1onub_128";
const fileExplorerPanel = "_fileExplorerPanel_1onub_135";
const editorPanel = "_editorPanel_1onub_146";
const ideContainer = "_ideContainer_1onub_153";
const vscodeContainer = "_vscodeContainer_1onub_160";
const jupyterContainer = "_jupyterContainer_1onub_161";
const terminalFullContainer = "_terminalFullContainer_1onub_162";
const jupyterIframe = "_jupyterIframe_1onub_169";
const terminalPanel = "_terminalPanel_1onub_178";
const terminalHeader = "_terminalHeader_1onub_190";
const rightSidebar = "_rightSidebar_1onub_206";
const resourcePanel = "_resourcePanel_1onub_218";
const aiAssistantToggle = "_aiAssistantToggle_1onub_223";
const aiAssistantPanel = "_aiAssistantPanel_1onub_228";
const loadingContainer = "_loadingContainer_1onub_236";
const errorContainer = "_errorContainer_1onub_253";
const styles = {
  labContainer,
  labHeader,
  labTitle,
...
const LabEnvironment = () => {
  const { labId, courseId: courseId2 } = useParams();
  ...
  const [selectedIDE, setSelectedIDE] = reactExports.useState("vscode");
  const [isFileExplorerOpen, setIsFileExplorerOpen] = reactExports.useState(true);
  const [isTerminalOpen, setIsTerminalOpen] = reactExports.useState(true);
  const [isAIAssistantOpen, setIsAIAssistantOpen] = reactExports.useState(false);
  const [codeContent, setCodeContent] = reactExports.useState("");
  const [sessionTimer2, setSessionTimer] = reactExports.useState(0);
    ...
    if (status === "running" && session) {
      timerInterval.current = setInterval(() => {
        const elapsed = Math.floor(
          (Date.now() - new Date(session.startTime).getTime()) / 1e3
        );
  ...
  const handleStartLab = reactExports.useCallback(async () => {
    try {
      await startLab();
    } catch (error) {
  ...
  const handlePauseLab = reactExports.useCallback(async () => {
    try {
      await pauseLab();
    } catch (error) {
  ...
  const handleResumeLab = reactExports.useCallback(async () => {
    try {
      await resumeLab();
    } catch (error) {
  ...
  const handleStopLab = reactExports.useCallback(async () => {
  ...
  const handleIDEChange = reactExports.useCallback((ide) => {
    setSelectedIDE(ide);
  }, []);
  const handleFileSelect = reactExports.useCallback(async (fileId) => {
    try {
  ...
  const handleCodeChange = reactExports.useCallback((newContent) => {
  ...
  const handleRunCode = reactExports.useCallback(async () => {
    if (!currentFile) return;
    try {
  ...
  const handleTerminalCommand = reactExports.useCallback(async (command) => {
    try {
      await executeCommand(command);
    } catch (error) {
  ...
  const getRunCommand = (language, fileName2) => {
    const commands = {
      python: `python ${fileName2}`,
      javascript: `node ${fileName2}`,
      typescript: `ts-node ${fileName2}`,
      java: `javac ${fileName2} && java ${fileName2.replace(".java", "")}`,
      cpp: `g++ ${fileName2} -o output && ./output`,
      c: `gcc ${fileName2} -o output && ./output`
    };
    return commands[language] || `cat ${fileName2}`;
  };
  ...
  if (sessionLoading || filesLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.loadingContainer, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading lab environment..." })
    ] });
  }
  if (sessionError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.errorContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { variant: "outlined", padding: "large", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Failed to Load Lab" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: sessionError }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", onClick: () => navigate("/dashboard/student"), children: "Return to Dashboard" })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.labContainer, "data-testid": "lab-environment", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: styles.labHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.labTitle, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Lab Environment" }),
        courseId2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles.courseId, children: [
          "Course: ",
          courseId2
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.headerControls, children: [
        status === "running" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.sessionTimer, id: "lab-timer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.timerIcon, children: "⏱" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.timerValue, children: formatTimer(sessionTimer2) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.sessionStatus, id: "lab-status", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${styles.statusIndicator} ${styles[status]}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.statusText, children: status.toUpperCase() })
        ] }),
        session && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.sessionId, id: "session-id", children: [
          "Session: ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.labContent, children: [
      isFileExplorerOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: styles.fileExplorerPanel, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        FileExplorer,
        {
          files,
          currentFile,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: styles.editorPanel, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          IDESelector,
          {
            selectedIDE,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.ideContainer, children: [
          selectedIDE === "vscode" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.vscodeContainer, id: "vscode-iframe", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            CodeEditor,
            {
              ref: editorRef,
              value: codeContent,
          ...
          selectedIDE === "jupyter" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.jupyterContainer, id: "jupyter-iframe", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "iframe",
            {
          ...
          selectedIDE === "terminal" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.terminalFullContainer, id: "terminal-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            TerminalEmulator,
            {
              history,
        ...
        selectedIDE !== "terminal" && isTerminalOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.terminalPanel, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.terminalHeader, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: styles.rightSidebar, children: [
        session && status === "running" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.resourcePanel, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceMonitor, { sessionId: session.id }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.aiAssistantToggle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            id: "ai-assistant-btn",
        ...
        isAIAssistantOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.aiAssistantPanel, id: "ai-assistant-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          AIAssistant,
          {
            currentFile,
            ...
            courseId: courseId2,
            jupyterContext: selectedIDE === "jupyter" ? jupyterContext : void 0,
            getJupyterAIContext: selectedIDE === "jupyter" ? getJupyterAIContext : void 0
          }
        ) })
      ] })
    ] })
...
export {
  LabEnvironment,
  LabEnvironment as default
};
//# sourceMappingURL=LabEnvironment-CBgwi1EM.js.map

...
from analytics.domain.entities.student_analytics import StudentActivity, ActivityType
from analytics.domain.interfaces.analytics_service import IStudentActivityService

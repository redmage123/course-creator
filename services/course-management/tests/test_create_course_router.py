"""
Tests for create_course router of course-management service
"""
...
@pytest.mark.asyncio
async def test_create_course_endpoints(async_client, mock_database):
    """Test create_course endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/create_course/")

"""
Tests for update_course router of course-management service
"""
...
@pytest.mark.asyncio
async def test_update_course_endpoints(async_client, mock_database):
    """Test update_course endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/update_course/")

"""
Tests for add_lesson router of course-management service
"""
...
@pytest.mark.asyncio
async def test_add_lesson_endpoints(async_client, mock_database):
    """Test add_lesson endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/add_lesson/")

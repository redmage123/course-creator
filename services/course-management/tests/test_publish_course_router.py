"""
Tests for publish_course router of course-management service
"""
...
@pytest.mark.asyncio
async def test_publish_course_endpoints(async_client, mock_database):
    """Test publish_course endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/publish_course/")

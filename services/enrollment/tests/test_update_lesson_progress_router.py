"""
Tests for update_lesson_progress router of enrollment service
"""
...
@pytest.mark.asyncio
async def test_update_lesson_progress_endpoints(async_client, mock_database):
    """Test update_lesson_progress endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/update_lesson_progress/")

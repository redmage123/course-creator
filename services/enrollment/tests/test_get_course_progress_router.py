"""
Tests for get_course_progress router of enrollment service
"""
...
@pytest.mark.asyncio
async def test_get_course_progress_endpoints(async_client, mock_database):
    """Test get_course_progress endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/get_course_progress/")

"""
Tests for unenroll_student router of enrollment service
"""
...
@pytest.mark.asyncio
async def test_unenroll_student_endpoints(async_client, mock_database):
    """Test unenroll_student endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/unenroll_student/")

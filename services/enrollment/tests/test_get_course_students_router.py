"""
Tests for get_course_students router of enrollment service
"""
...
@pytest.mark.asyncio
async def test_get_course_students_endpoints(async_client, mock_database):
    """Test get_course_students endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/get_course_students/")

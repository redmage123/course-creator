"""
Tests for get_student_courses router of enrollment service
"""
...
@pytest.mark.asyncio
async def test_get_student_courses_endpoints(async_client, mock_database):
    """Test get_student_courses endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/get_student_courses/")

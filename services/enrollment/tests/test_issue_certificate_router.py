"""
Tests for issue_certificate router of enrollment service
"""
...
@pytest.mark.asyncio
async def test_issue_certificate_endpoints(async_client, mock_database):
    """Test issue_certificate endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/issue_certificate/")

"""
Tests for get_enrollment router of enrollment service
"""
...
@pytest.mark.asyncio
async def test_get_enrollment_endpoints(async_client, mock_database):
    """Test get_enrollment endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/get_enrollment/")

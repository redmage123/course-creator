"""
Tests for update_profile router of user-management service
"""
...
@pytest.mark.asyncio
async def test_update_profile_endpoints(async_client, mock_database):
    """Test update_profile endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/update_profile/")

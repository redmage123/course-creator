"""
Tests for list_content router of content-management service
"""
...
@pytest.mark.asyncio
async def test_list_content_endpoints(async_client, mock_database):
    """Test list_content endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/list_content/")

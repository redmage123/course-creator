"""
Tests for get_content_by_lesson router of content-management service
"""
...
@pytest.mark.asyncio
async def test_get_content_by_lesson_endpoints(async_client, mock_database):
    """Test get_content_by_lesson endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/get_content_by_lesson/")

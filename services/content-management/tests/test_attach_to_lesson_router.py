"""
Tests for attach_to_lesson router of content-management service
"""
...
@pytest.mark.asyncio
async def test_attach_to_lesson_endpoints(async_client, mock_database):
    """Test attach_to_lesson endpoints"""
    
    # Test endpoint accessibility
    with patch('dependencies.get_database', return_value=mock_database):
        response = await async_client.get("/attach_to_lesson/")

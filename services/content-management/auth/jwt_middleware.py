"""
JWT Authentication Middleware for Content Management Service

BUSINESS CONTEXT:
Provides centralized JWT token validation for all protected content management endpoints.
Ensures only authenticated users can access, modify, or delete educational content.
...
async def get_current_user(
    ...
    Returns:
        Dict containing user info (user_id, role, username, email)

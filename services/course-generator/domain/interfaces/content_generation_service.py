...
from domain.entities.course_content import Syllabus, Slide, Exercise, LabEnvironment, GenerationJob
from domain.entities.quiz import Quiz, QuizQuestion, QuizGenerationRequest
from domain.entities.student_interaction import StudentProgress, ChatInteraction, LabSession

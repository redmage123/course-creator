...
from course_generator.domain.entities.quiz import Quiz, QuizQuestion, QuizAttempt, QuizGenerationRequest, QuestionType, DifficultyLevel
from course_generator.domain.interfaces.content_generation_service import IQuizGenerationService

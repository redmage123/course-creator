...
from course_generator.domain.entities.course_content import GenerationJob, JobStatus, ContentType
from course_generator.domain.interfaces.content_generation_service import IJobManagementService
# Repository pattern removed - using DAO
from data_access.course_generator_dao import CourseGeneratorDAO
from course_generator.domain.interfaces.ai_service import IAIService

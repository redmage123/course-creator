...
from course_generator.domain.entities.course_content import Exercise, ExerciseType, DifficultyLevel
from course_generator.domain.interfaces.content_generation_service import IExerciseGenerationService

...
from course_generator.domain.entities.course_content import Syllabus, Slide, Exercise, LabEnvironment, GenerationJob
from course_generator.domain.entities.quiz import Quiz, QuizQuestion, QuizGenerationRequest
from course_generator.domain.entities.student_interaction import StudentProgress, ChatInteraction, LabSession

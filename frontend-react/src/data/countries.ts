 ...
 *
 * BUSINESS CONTEXT:
 * Provides comprehensive country list for phone number input and country selection.
 * Used in organization registration and contact forms.
 *
 * TECHNICAL IMPLEMENTATION:
 * - Flag emojis for visual identification
 * - ISO 3166-1 alpha-2 country codes
 * - International dialing codes (E.164 format)
 * - Sorted with United States first as default, then alphabetically
 */
...
export interface Country {
  ...
  /**
   * International dialing code with + prefix (e.g., "+1", "+44")
   */
  dialCode: string;
...
/**
 * Complete list of countries with phone codes and flag emojis.
 * United States is listed first as the default, followed by other

"""
Unit Tests for Advanced Assessment Service

WHAT: Unit tests for AdvancedAssessmentService business logic
WHERE: Run during CI/CD and local development
WHY: Ensures service layer correctly implements business rules
     and properly orchestrates domain entities and DAO
...
Testing Approach:
- Uses mock DAO to isolate service logic
...
# ============================================================================
# Mock data_access module BEFORE importing the service
# This prevents import collision with other services' data_access modules
# ============================================================================

# Create mock DAO class and exception
class MockAdvancedAssessmentDAO:
    """Mock DAO for testing - accepts pool argument like real DAO"""
    def __init__(self, pool):
        self.pool = pool

class MockAdvancedAssessmentDAOException(Exception):
    """Mock DAO exception for testing"""
    pass

# Create mock module
mock_dao_module = MagicMock()
mock_dao_module.AdvancedAssessmentDAO = MockAdvancedAssessmentDAO
mock_dao_module.AdvancedAssessmentDAOException = MockAdvancedAssessmentDAOException

# Insert mock into sys.modules to prevent real import
sys.modules['data_access.advanced_assessment_dao'] = mock_dao_module

# Now import service (will use mocked DAO module)
...
def mock_pool():
    """
    WHAT: Creates mock database connection pool
    WHERE: Used in all service tests
    WHY: Isolates service logic from database
    """
    return MagicMock()
...
def mock_dao():
    """
    WHAT: Creates mock DAO with async methods
    WHERE: Used to mock database operations
    WHY: Enables isolated unit testing of service logic
    """
    dao = MagicMock()
    # Configure all methods as AsyncMock
    dao.create_rubric = AsyncMock()
    dao.get_rubric_by_id = AsyncMock()
    dao.get_rubrics_by_course = AsyncMock()
    dao.get_template_rubrics = AsyncMock()
    dao.update_rubric = AsyncMock()
    dao.delete_rubric = AsyncMock()
    dao.create_assessment = AsyncMock()
    dao.get_assessment_by_id = AsyncMock()
    dao.get_assessments_by_course = AsyncMock()
    dao.get_available_assessments = AsyncMock()
    dao.update_assessment = AsyncMock()
    dao.delete_assessment = AsyncMock()
    dao.create_submission = AsyncMock()
    dao.get_submission_by_id = AsyncMock()
    dao.get_submissions_by_assessment = AsyncMock()
    dao.get_student_submissions = AsyncMock()
    dao.get_submissions_to_grade = AsyncMock()
    dao.update_submission = AsyncMock()
    dao.create_evaluation = AsyncMock()
    dao.get_evaluations_for_submission = AsyncMock()
    dao.update_evaluation = AsyncMock()
    dao.create_peer_review_assignment = AsyncMock()
    dao.get_peer_assignment_by_id = AsyncMock()
    dao.get_assignments_for_reviewer = AsyncMock()
    dao.update_peer_assignment = AsyncMock()
    dao.create_peer_review = AsyncMock()
    dao.get_reviews_for_submission = AsyncMock()
    dao.create_competency = AsyncMock()
    dao.get_competency_by_id = AsyncMock()
    dao.get_competency_by_code = AsyncMock()
    dao.get_competencies_by_organization = AsyncMock()
    dao.update_competency = AsyncMock()
    dao.create_competency_progress = AsyncMock()
    dao.get_student_competency_progress = AsyncMock()
    dao.get_student_competencies = AsyncMock()
    dao.update_competency_progress = AsyncMock()
    dao.create_artifact = AsyncMock()
    dao.get_artifact_by_id = AsyncMock()
    dao.update_artifact = AsyncMock()
    dao.delete_artifact = AsyncMock()
    dao.create_milestone = AsyncMock()
    dao.get_milestone_by_id = AsyncMock()
    dao.update_milestone = AsyncMock()
    dao.delete_milestone = AsyncMock()
    dao.create_or_update_analytics = AsyncMock()
    dao.get_analytics_by_assessment = AsyncMock()
    return dao


@pytest.fixture
def service(mock_pool, mock_dao):
    """
    WHAT: Creates service with mocked dependencies
    WHERE: Used in all service tests
    WHY: Provides isolated service instance for testing
    """
    svc = AdvancedAssessmentService(mock_pool)
    svc.dao = mock_dao
    return svc

...
class TestSubProjectCreation:
    ...
    def test_create_sub_project_success(self, sub_project_dao, db_connection, sample_sub_project_data):
    ...
    def test_create_sub_project_with_duplicate_slug(self, sub_project_dao, db_connection, sample_sub_project_data):
    ...
    def test_create_sub_project_auto_calculates_duration(self, sub_project_dao, db_connection, sample_sub_project_data):
...
class TestSubProjectRetrieval:
    ...
    def test_get_sub_project_by_id_success(self, sub_project_dao, db_connection, sample_sub_project_data):
    ...
    def test_get_sub_project_by_id_not_found(self, sub_project_dao, db_connection):
    ...
    def test_get_sub_projects_by_parent_project(self, sub_project_dao, db_connection, sample_sub_project_data):
    ...
    def test_get_sub_projects_with_location_filter(self, sub_project_dao, db_connection, sample_sub_project_data):
    ...
    def test_get_sub_projects_with_date_range_filter(self, sub_project_dao, db_connection, sample_sub_project_data):
    ...
    def test_get_sub_projects_with_status_filter(self, sub_project_dao, db_connection, sample_sub_project_data):
...
class TestSubProjectUpdate:
    ...
    def test_update_sub_project_success(self, sub_project_dao, db_connection, sample_sub_project_data):
    ...
    def test_update_sub_project_not_found(self, sub_project_dao, db_connection):
...
class TestSubProjectDeletion:
    ...
    def test_delete_sub_project_success(self, sub_project_dao, db_connection, sample_sub_project_data):
    ...
    def test_delete_sub_project_not_found(self, sub_project_dao, db_connection):
    ...
    def test_delete_sub_project_cascades_to_tracks(self, sub_project_dao, db_connection, sample_sub_project_data):
...
class TestSubProjectTrackAssignment:
    ...
    def test_assign_track_to_sub_project(self, sub_project_dao, db_connection):
    ...
    def test_assign_duplicate_track_fails(self, sub_project_dao, db_connection):
    ...
    def test_get_tracks_for_sub_project(self, sub_project_dao, db_connection):
...
class TestSubProjectCapacityManagement:
    ...
    def test_increment_participant_count(self, sub_project_dao, db_connection):
    ...
    def test_increment_participant_count_at_capacity_fails(self, sub_project_dao, db_connection):
    ...
    def test_decrement_participant_count(self, sub_project_dao, db_connection):
...
class TestSubProjectStatusTransitions:
    ...
    def test_activate_sub_project(self, sub_project_dao, db_connection):
    ...
    def test_complete_sub_project(self, sub_project_dao, db_connection):

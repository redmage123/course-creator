...
NOTE: This test suite has been refactored to remove mock usage.
Tests that require external services are marked with @pytest.mark.skip
and should be reimplemented with real service implementations.
...
- Integration tests for bulk enrollment workflow (skipped - needs real services)
- E2E tests for complete user journey (skipped - needs real services)
"""
import pytest
import pandas as pd
import io

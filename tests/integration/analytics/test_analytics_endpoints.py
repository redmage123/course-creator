...
class TestActivityTrackingEndpoints:
    ...
    def test_track_single_activity_success(self, test_client, auth_headers, sample_activity_data):
...
class TestLabUsageEndpoints:
    ...
    def test_track_lab_usage_success(self, test_client, auth_headers):
...
class TestQuizPerformanceEndpoints:
    ...
    def test_track_quiz_performance_success(self, test_client, auth_headers):
...
class TestStudentProgressEndpoints:
    ...
    def test_update_student_progress_success(self, test_client, auth_headers):
...
class TestAnalyticsRetrievalEndpoints:
    ...
    def test_get_student_analytics_success(self, test_client, auth_headers):
